...
goog.exportSymbol('proto.CreateBookRequest.CreateData', null, global);
 ...
 * @constructor
 */
proto.CreateBookRequest.CreateData = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.CreateBookRequest.CreateData, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.CreateBookRequest.CreateData.displayName = 'proto.CreateBookRequest.CreateData';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.CreateBookRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    book: (f = msg.getBook()) && proto.CreateBookRequest.CreateData.toObject(includeInstance, f)
  };
...
proto.CreateBookRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.CreateBookRequest.CreateData;
      reader.readMessage(value,proto.CreateBookRequest.CreateData.deserializeBinaryFromReader);
      msg.setBook(value);
      break;
    default:
      reader.skipField();
...
proto.CreateBookRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.CreateBookRequest.CreateData.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.CreateBookRequest.CreateData.prototype.toObject = function(opt_includeInstance) {
  return proto.CreateBookRequest.CreateData.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.CreateBookRequest.CreateData} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CreateBookRequest.CreateData.toObject = function(includeInstance, msg) {
  var f, obj = {
    title: jspb.Message.getFieldWithDefault(msg, 2, ""),
    author: jspb.Message.getFieldWithDefault(msg, 3, ""),
    description: jspb.Message.getFieldWithDefault(msg, 4, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.CreateBookRequest.CreateData}
 */
proto.CreateBookRequest.CreateData.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.CreateBookRequest.CreateData;
  return proto.CreateBookRequest.CreateData.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.CreateBookRequest.CreateData} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.CreateBookRequest.CreateData}
 */
proto.CreateBookRequest.CreateData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.CreateBookRequest.CreateData.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.CreateBookRequest.CreateData.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.CreateBookRequest.CreateData} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.CreateBookRequest.CreateData.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTitle();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.CreateBookRequest.CreateData.prototype.getTitle = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.setTitle = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.CreateBookRequest.CreateData.prototype.getAuthor = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.setAuthor = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.CreateBookRequest.CreateData.prototype.getDescription = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.setDescription = function(value) {
  return jspb.Message.setField(this, 4, value);
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.clearDescription = function() {
  return jspb.Message.setField(this, 4, undefined);
};
 ...
 * @return {boolean}
 */
proto.CreateBookRequest.CreateData.prototype.hasDescription = function() {
  return jspb.Message.getField(this, 4) != null;
};
 ...
 * @return {string}
 */
proto.CreateBookRequest.CreateData.prototype.getImageUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.setImageUrl = function(value) {
  return jspb.Message.setField(this, 5, value);
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.clearImageUrl = function() {
  return jspb.Message.setField(this, 5, undefined);
};
 ...
 * @return {boolean}
 */
proto.CreateBookRequest.CreateData.prototype.hasImageUrl = function() {
  return jspb.Message.getField(this, 5) != null;
};
 ...
 * @return {number}
 */
proto.CreateBookRequest.CreateData.prototype.getPrice = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.setPrice = function(value) {
  return jspb.Message.setField(this, 6, value);
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.clearPrice = function() {
  return jspb.Message.setField(this, 6, undefined);
};
 ...
 * @return {boolean}
 */
proto.CreateBookRequest.CreateData.prototype.hasPrice = function() {
  return jspb.Message.getField(this, 6) != null;
};
 ...
 * @return {number}
 */
proto.CreateBookRequest.CreateData.prototype.getPages = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.setPages = function(value) {
 ...
 * @return {?proto.google.protobuf.Timestamp}
 */
proto.CreateBookRequest.CreateData.prototype.getPublishedDate = function() {
  return /** @type{?proto.google.protobuf.Timestamp} */ (
    jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 8));
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
*/
proto.CreateBookRequest.CreateData.prototype.setPublishedDate = function(value) {
  return jspb.Message.setWrapperField(this, 8, value);
};
 ...
 * @return {!proto.CreateBookRequest.CreateData} returns this
 */
proto.CreateBookRequest.CreateData.prototype.clearPublishedDate = function() {
  return this.setPublishedDate(undefined);
};
 ...
 * @return {boolean}
 */
proto.CreateBookRequest.CreateData.prototype.hasPublishedDate = function() {
  return jspb.Message.getField(this, 8) != null;
};


/**
 * optional CreateData book = 1;
 * @return {?proto.CreateBookRequest.CreateData}
 */
proto.CreateBookRequest.prototype.getBook = function() {
  return /** @type{?proto.CreateBookRequest.CreateData} */ (
    jspb.Message.getWrapperField(this, proto.CreateBookRequest.CreateData, 1));
};


/**
 * @param {?proto.CreateBookRequest.CreateData|undefined} value
